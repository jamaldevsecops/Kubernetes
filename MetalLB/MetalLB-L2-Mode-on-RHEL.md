...
**Mode:** Layer 2 (L2)
**IP Pool:** 192.168.20.131–192.168.20.133
...
Environment="NO_PROXY=localhost,127.0.0.1,192.168.0.0/24,10.244.0.0/16,10.96.0.0/12,kubeapi.nagad.com,.cluster.local"
EOF
...
```
EXTERNAL-IP = 192.168.20.131-124
```
